...
public interface IWannaBookService extends Remote{
	// 희망도서
		 ...
		 * @author jaeho
		 */
		public int updateAcceptWannaBook(WannaBookVO wannaBookvo) throws RemoteException;
		 ...
		 * @author jaeho
		 */
		public int updateRejectWannaBook(WannaBookVO wannaBookvo) throws RemoteException;
		...
		public int deleteWannBook(WannaBookVO wannaBookvo) throws RemoteException; 
}
